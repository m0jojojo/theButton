      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-8">
          <p className="text-gray-700 mb-6 leading-relaxed">
            ...
            about fashion and customer service, we&apos;d love to hear from you!
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            Currently, we don&apos;t have any open positions, but we&apos;re always accepting applications 
            for future opportunities.
          </p>
        </section>

        <section>
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">How to Apply</h2>
          <p className="text-gray-700 mb-4 leading-relaxed">
            Interested in joining our team? Send us your resume and a brief introduction on WhatsApp, 
            and we&apos;ll get back to you if we have a suitable opportunity.
          </p>
          <a
